...
const musicsound=new Audio("Music Sound.mp3")
...
function isCollide(snake){
    ...
    for(let i=1;i<snakeArr.length;i++){
        ...
        else if(snake[0].x >=18 || snake[0].x==0 || snake[0].y >=18 || snake[0].y==0){
            return true;
        }
    }
}
...
function gameEngine(){
    ...
    //part2- Dispalay the snake and food
...
if(hiscore===null){
    hiscoreval=0;
    localStorage.setItem("hiscoe",JSON.stringify(hiscoreval))
